...
export const useSettingsStore = defineStore('settings', () => {
  ...
  const contactEmail = ref('info@mercandanismanlik.com')
  const phoneNumber = ref('+90 532 317 17 55')
  const address = ref('İskele Mahallesi Bademli Caddesi Hanlılar 2 Sitesi 43/6 Datça Muğla')
