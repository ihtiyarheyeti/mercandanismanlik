<template>
  <div class="p-6">
    <h1 class="text-2xl font-bold mb-6">SEO Yönetimi</h1>

    <div class="bg-white rounded-lg shadow p-6">
      <form @submit.prevent="saveSeoSettings">
        <!-- Meta Etiketleri -->
        <div class="mb-6">
          <h2 class="text-xl font-semibold mb-4">Meta Etiketleri</h2>
        ...
        <!-- Site Haritası -->
        <div class="mb-6">
          <h2 class="text-xl font-semibold mb-4">Site Haritası</h2>
        ...
        <!-- URL Yapısı -->
        <div class="mb-6">
          <h2 class="text-xl font-semibold mb-4">URL Yapısı</h2>
...
onMounted(async () => {
  try {
    ...
    seoSettings.value = {
      ...
      autoGenerateSitemap: settings.auto_generate_sitemap,
      includeImagesSitemap: settings.include_images_sitemap,
      submitToSearchEngines: settings.submit_to_search_engines,
      urlStructure: settings.url_structure
    }
  } catch (error) {
...
const saveSeoSettings = async () => {
  isSaving.value = true
  try {
    await settingsStore.updateSeoSettings({
      metaTitle: seoSettings.value.metaTitle,
      metaDescription: seoSettings.value.metaDescription,
      metaKeywords: seoSettings.value.metaKeywords,
      robotsTxt: seoSettings.value.robotsTxt,
      autoGenerateSitemap: seoSettings.value.autoGenerateSitemap,
      includeImagesSitemap: seoSettings.value.includeImagesSitemap,
      submitToSearchEngines: seoSettings.value.submitToSearchEngines,
      urlStructure: seoSettings.value.urlStructure
    })
