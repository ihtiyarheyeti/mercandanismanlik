...
class SettingsController extends Controller
{
    ...
    public function update(Request $request)
    {
        try {
            ...
            \Log::info('Gelen veri türü:', gettype($request->all()));
            ...
            $validated = $request->validate([
                ...
                'working_hours_weekday' => 'nullable|string',
                'working_hours_saturday' => 'nullable|string',
                'working_hours_sunday' => 'nullable|string',
                'is_open_saturday' => 'nullable|boolean',
                'is_open_sunday' => 'nullable|boolean'
            ]);

            \Log::info('Validasyon başarılı');
            \Log::info('Doğrulanmış veri:', $validated);
            ...
            \Log::info('Kaydedilen ayarlar:', $settings->toArray());
